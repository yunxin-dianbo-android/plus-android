...
public class TrimVideoUtil {
     ...
     * @param callback
     */
    public static void trim(Context context, String inputFile, String outputFile, long startMs, long
    ...
    public static Observable<Bitmap> getVideoOneFrame(final String videoUrl) {
                                           ...
                                           try {
                                               ...
                                               if (cursor != null) {
                                                   while (cursor.moveToNext()) {
                                                       ...
                                                       //                    getVideoWithAndHeight(video);

                                                       videos.add(video);
                                                       if (videos.size() >= 100) {
                                                           callback.onSingleCallback(new ArrayList<>(videos), 100);
                                                           videos.clear();
                                                       }
