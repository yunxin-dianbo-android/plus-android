...
public class EaseMessageAdapter extends BaseAdapter {
    ...
    public int getViewTypeCount() {
        if (customRowProvider != null && customRowProvider.getCustomChatRowTypeCount() > 0) {
            return customRowProvider.getCustomChatRowTypeCount();
        }
        return 28;
    }
    ...
    public int getItemViewType(int position) {
        ...
        if (customRowProvider != null && customRowProvider.getCustomChatRowType(message) > 0) {
            return customRowProvider.getCustomChatRowType(message);
        }
...
//            if (presenter.getClass().getSimpleName().equals(((EaseChatRowPresenter) convertView.getTag()).getClass().getSimpleName())) {
//            } else {
//                if ("TSChatTipTextPresenter".equals(presenter.getClass().getSimpleName())) {
//                    convertView = presenter.createChatRow(context, message, position, this, mOnTipMsgClickListener);
//                } else {
...
//            }
        ...
        presenter.setMessageErrorListener(mMessageErrorListener);
