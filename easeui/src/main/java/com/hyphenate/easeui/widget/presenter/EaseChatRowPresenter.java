...
public abstract class EaseChatRowPresenter implements EaseChatRow.EaseChatRowActionCallback {
    ...
    protected void
    handleSendMessage(final EMMessage message) {
        ...
        message.setMessageStatusCallback(new EMCallBack() {
            ...
            public void onError(int code, String error) {
                ...
                getChatRow().updateView(message);
                handleSendMessageError(message,code,error);
            }
    ...
    protected void handleSendMessageError(EMMessage message, int code, String error) {
        if (mMessageErrorListener!=null){
            mMessageErrorListener.handleSendMessageError(message,code,error);
        }
    }
    ...
    public MessageErrorListener getMessageErrorListener() {
        return mMessageErrorListener;
    }

    public void setMessageErrorListener(MessageErrorListener messageErrorListener) {
        mMessageErrorListener = messageErrorListener;
    }

    public interface MessageErrorListener{
        void handleSendMessageError(EMMessage message, int code, String error);
    }
}
