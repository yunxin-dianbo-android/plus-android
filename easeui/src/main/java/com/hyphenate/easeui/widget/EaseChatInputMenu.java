...
public class EaseChatInputMenu extends LinearLayout {
    protected FrameLayout primaryMenuContainer, emojiconMenuContainer;
    ...
    protected void processChatMenu() {
        ...
        emojiconMenu.setEmojiconMenuListener(new EaseEmojiconMenuListener() {
            ...
            public void onExpressionClicked(EaseEmojicon emojicon) {
                ...
                } else if (emojicon.getType() == EaseEmojicon.Type.UNICODE) {
                    if (emojicon.getEmoji() != null) {
                        chatPrimaryMenu.onEmojiconInputEvent(EaseSmileUtils.getSmiledText(context, emojicon.getEmoji()));
                    }
                } else {
                    if (listener != null) {
