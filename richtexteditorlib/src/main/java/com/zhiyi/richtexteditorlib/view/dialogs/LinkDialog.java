...
public class LinkDialog extends BaseDialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ok = (TextView) dialog.findViewById(R.id.confirm_btn);
    ...
    public void setErrorMessage(String string,boolean controOkButton) {
        if (TextUtils.isEmpty(string)){
            errorTip.setVisibility(View.GONE);
            errorTip.setText("");
            if (controOkButton){
    ...
    class MaxTextLengthFilter implements InputFilter {
        ...
        public CharSequence filter(CharSequence source, int start, int end,
            ...
            if (keep < (end - start)) {
                setErrorMessage("编辑群名称，2–15个字符",false);
            }else{
