...
public class HorizontalStackIconView extends FrameLayout {
    ...
    private void init(Context context) {
        ...
        mImageViews[0] = findViewById(R.id.iv_dig_head1);
        mImageViews[1] = findViewById(R.id.iv_dig_head2);
        mImageViews[2] = findViewById(R.id.iv_dig_head3);
        mImageViews[3] = findViewById(R.id.iv_dig_head4);
        mImageViews[4] = findViewById(R.id.iv_dig_head5);
        mTvExpertCount = findViewById(R.id.tv_expert_count);
    }


    public void setExpertUserHeadIcon(List<UserInfoBean> expertList) {
        if (expertList == null || expertList.size() == 0) {
            ...
            for (int i = 0; i < mImageViews.length; i++) {
                ...
                if (i < expertList.size()) {
                    ...
                    ImageUtils.loadCircleUserHeadPicWithBorder(userInfoBean,mImageViews[i]);
