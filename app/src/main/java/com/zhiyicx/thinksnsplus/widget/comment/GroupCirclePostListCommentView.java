...
// */
//
//public class GroupCirclePostListCommentView extends LinearLayout {
...
//
//    public GroupCirclePostListCommentView(Context context) {
//        super(context);
//        init();
//    }
//
//    public GroupCirclePostListCommentView(Context context, AttributeSet attrs) {
//        super(context, attrs);
//        init();
//    }
//
//    public GroupCirclePostListCommentView(Context context, AttributeSet attrs, int defStyleAttr) {
