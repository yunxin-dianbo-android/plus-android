...
import com.zhiyicx.thinksnsplus.widget.dragview.ExplosionField.ExplosionField;
import com.zhiyicx.thinksnsplus.widget.dragview.ExplosionField.Utils;
...
public class DragGridView extends GridView {
    ...
    private static final int DEFAULT_DRAG_BG_COLOR = Color.parseColor("#00f5f5f5");
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (null != first_view){
            ...
            paint.setColor(Color.parseColor("#00e5e5e5"));
    ...
    public void setOnItemClickListener(final MotionEvent ev) {
        setOnItemLongClickListener(new OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (startPosition < mFixed_nums) {
                    return false;
                }
                dragViewGroup = (ViewGroup) getChildAt(dragPosition - getFirstVisiblePosition());
                TextView dragTextView = (TextView) dragViewGroup.findViewById(R.id.tv_tag_name);
