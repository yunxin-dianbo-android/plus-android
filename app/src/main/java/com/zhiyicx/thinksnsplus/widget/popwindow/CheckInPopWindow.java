...
public class CheckInPopWindow extends PopupWindow {
    ...
    public void setData(CheckInBean checkInBean, double walletRatio, String goldName) {
        ...
        mTvTotoalGold.setText("+" + mContentView.getResources().getString(R.string.buy_pay_integration,PayConfig.realCurrency2GameCurrencyStr
                (checkInBean.getAttach_balance(),(int)walletRatio)));
        mListData.clear();
