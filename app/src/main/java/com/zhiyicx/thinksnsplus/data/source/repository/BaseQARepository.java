...
public class BaseQARepository implements IBasePublishQuestionRepository {
    ...
    @Override
    public Observable<SystemConfigBean.QuestionConfig> getQuestionConfig() {
    ...
    @Override
    public Observable<BaseJsonV2<AnswerInfoBean>> payForOnlook(Long answer_id, String psd) {
        return mQAClient.payForOnlook(answer_id, psd)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread());
    }
    ...
    public Observable<BaseJsonV2<Object>> deleteQuestion(Long question_id) {
        return TSUerPerMissonUtil.getInstance().canDeleteQuestion() ? mQAClient.managerDeleteQuestion(String.valueOf(question_id)) :
                mQAClient.deleteQuestion(String.valueOf(question_id));
    }

    @Override
    public Observable<BaseJsonV2<Object>> applyForExcellent(Long question_id, String psd) {
        return mQAClient.applyForExcellent(String.valueOf(question_id), psd)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread());
    }
    ...
    @Override
    public Observable<List<AnswerCommentListBean>> getAnswerCommentList(long answerId, long maxId) {
        return mQAClient.getAnswerCommentList(answerId, maxId, TSListFragment.DEFAULT_PAGE_SIZE)
                .subscribeOn(Schedulers.io())
                .observeOn(Schedulers.io())
...
//        BackgroundTaskManager.getInstance(mContext).addBackgroundRequestTask(backgroundRequestTaskBean);
    ...
    @Override
    public void deleteAnswer(long answer_id, BackgroundTaskHandler.OnNetResponseCallBack callBack) {
        BackgroundRequestTaskBean backgroundRequestTaskBean;
        // 后台处理
        backgroundRequestTaskBean = new BackgroundRequestTaskBean(BackgroundTaskRequestMethodConfig.DELETE_V2, null);
        backgroundRequestTaskBean.setPath(String.format(Locale.getDefault(), TSUerPerMissonUtil.getInstance().canDeleteAnswer() ?
                ApiConfig.APP_PATH_MANAGER_DELETE_ANSWER_S : ApiConfig.APP_PATH_DELETE_ANSWER_S, answer_id));
    ...
    @Override
    public Observable<BaseJsonV2<QAListInfoBean>> publishQuestion(QAPublishBean qaPublishBean) {
    ...
    @Override
    public Observable<BaseJsonV2<QAListInfoBean>> updateQuestion(QAPublishBean qaPublishBean) {
        RequestBody body = RequestBody.create(okhttp3.MediaType.parse("application/json;charset=UTF-8"), new Gson().toJson(qaPublishBean));
     ...
     */
    @Override
    public Observable<BaseJsonV2<Object>> resetReward(Long question_id, double amount, String psd) {
        return mQAClient.updateQuestionReward(String.valueOf(question_id), (int) amount, psd)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread());
    }
}
