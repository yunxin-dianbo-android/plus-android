...
public class InfoListBeanGreenDaoImpl extends CommonCacheImpl<InfoListBean> {
    ...
    public void saveMultiData(List<InfoListBean> multiData) {
        getWDaoSession().getInfoListBeanDao().insertOrReplaceInTx(multiData);
    }
    ...
    public InfoListBean getSingleDataFromCache(Long primaryKey) {
        return getRDaoSession().getInfoListBeanDao().load(primaryKey);
    }
    ...
    public void deleteSingleCache(Long primaryKey) {
        getWDaoSession().getInfoListBeanDao().deleteByKey(primaryKey);
    }

    @Override
    public void deleteSingleCache(InfoListBean dta) {
        getWDaoSession().getInfoListBeanDao().delete(dta);
    }

    @Override
    public void updateSingleData(InfoListBean newData) {
        getWDaoSession().getInfoListBeanDao().insertOrReplace(newData);
    }
    ...
    public long insertOrReplace(InfoListBean newData) {
        ...
        return getRDaoSession().getInfoListBeanDao().insertOrReplace(newData);
    }

    public InfoListBean getInfoListByInfoType(long info_type) {
        List<InfoListBean> infoListBeen = getRDaoSession().getInfoListBeanDao().queryBuilder()
