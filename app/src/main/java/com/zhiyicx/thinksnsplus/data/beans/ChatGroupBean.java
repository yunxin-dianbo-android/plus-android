...
public class ChatGroupBean extends BaseListBean implements Parcelable, Serializable {
    ...
    public ChatGroupBean(ChatGroupBeanForGroupList groupList) {
        id = groupList.getId();
        name = groupList.getName();
        description = groupList.getDescription();
        allowinvites = groupList.getAllowinvites();
        maxusers = groupList.getMaxusers();
        owner = groupList.getOwner();
        created = groupList.getCreated();
        affiliations_count = groupList.getAffiliations_count();
        isPublic = groupList.isPublic();
    }
