...
public class InfoTypeBeanGreenDaoImpl extends CommonCacheImpl<InfoTypeBean> {
    ...
    public void clearTable() {
        getWDaoSession().getInfoTypeCatesBeanDao().deleteAll();
    }
    ...
    public void updateSingleData(InfoTypeBean newData) {
        ...
        getWDaoSession().getInfoTypeCatesBeanDao().insertOrReplaceInTx(saveDatas);
    }
    ...
    public List<InfoTypeCatesBean> getMyCatesList() {
        return getRDaoSession().getInfoTypeCatesBeanDao()
                .queryBuilder()
    ...
    public List<InfoTypeCatesBean> getAllCatesLists() {
        return getRDaoSession().getInfoTypeCatesBeanDao().loadAll();
    }
