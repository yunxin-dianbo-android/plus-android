...
public class SendDynamicDataBean implements Serializable, Parcelable {
    ...
    public static final int TOPIC_DYNAMIC = 2;// 属于频道的动态类型，会显示在频道和首页
    public static final int FORWARD_DYNAMIC = 3;// 属于转发动态类型
    ...
    private List<TopicListBean> mTopics; // 话题信息
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeTypedList(this.mTopics);
    }
    ...
    protected SendDynamicDataBean(Parcel in) {
        ...
        this.mTopics = in.createTypedArrayList(TopicListBean.CREATOR);
    }
