...
public class QAPublishBean extends BaseDraftBean implements Parcelable {
    ...
    @Generated(hash = 605793048)
    public QAPublishBean(String subject, List<Topic> topics, List<Invitations> invitations, String body,
            String password, String text_body, int anonymity, int automaticity, int look, double amount,
            Long id, Long mark, Long user_id, String updated_at, String created_at,
            boolean hasAgainEdite, boolean hasAdoption) {
        this.subject = subject;
        this.topics = topics;
        this.invitations = invitations;
        this.body = body;
