...
import static com.zhiyicx.baseproject.config.ApiConfig.APP_PATH_GET_POSTLIST_BY_ID;
import static com.zhiyicx.baseproject.config.ApiConfig.APP_PATH_GET_PRE_POSTLIST;
...
public interface CircleClient {
    ...
    Observable<List<CircleInfo>> getCircleList(@Path("category_id") long categoryId,
     ...
     */
    @GET(APP_PATH_GET_RECOMMEND_CIRCLE)
    Observable<List<CircleInfo>> getAllCircle(@Query("limit") Integer limit, @Query("offset") int offset, @Query("type") String type);
    ...
    Observable<List<CircleInfo>> getAllCircle(@Query("limit") Integer limit,
    ...
    @FormUrlEncoded
    Observable<BaseJsonV2<Object>> joinCircle(@Path("circle_id") long circleId,@Field("password") String psd);
    ...
    Observable<CirclePostBean> getPostListFromCircle(@Path("circle_id") long circleId,
                                                     @Query("limit") Integer limit,
                                                     @Query("offset") int offset,
     ...
     * @return
     */
    @GET(APP_PATH_GET_PRE_POSTLIST)
    Observable<List<CirclePostListBean>> getPrePostListFromCircle(@Path("circle_id") Long circleId);

    /**
     * 批量获取帖子简单数据
     *
     * @param id 需要获取的帖子 ID， 多个使用半角 , 进行分割
     * @return
     */
    @GET(APP_PATH_GET_POSTLIST_BY_ID)
    Observable<List<SimplePostBean>> getPostListByIds(@Query("id") String id);
    ...
    Observable<BaseJsonV2<Integer>> stickTopPost(@Path("post_id") Long parent_id,
                                                 @Field("amount") Long amount, @Field("day") Integer day,@Field("password") String psd);
    ...
    Observable<BaseJsonV2<Integer>> stickTopPostComment(@Field("post_id") Long parent_id, @Path("comment_id") Long child_id, @Field("amount") Long
            amount, @Field("day") Integer day,@Field("password") String psd);
    ...
    Observable<Object> rewardPost(@Path("post_id") Long postId, @Field("amount") Long amount, @Field("password") String psd);
