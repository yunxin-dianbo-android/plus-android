...
public class StickTopRepsotory implements IStickTopRepository {
    ...
    @Override
    public Observable<BaseJsonV2<Integer>> stickTop(String type, long parentId, double amount, int day,String psd) {
        switch (type) {
            case TYPE_DYNAMIC:
                return mDynamicClient.stickTopDynamic(parentId, (long) amount, day,psd)
                        .subscribeOn(Schedulers.io())
                        .unsubscribeOn(Schedulers.io())
                        .observeOn(AndroidSchedulers.mainThread());
            case TYPE_INFO:
                return mInfoMainClient.stickTopInfo(parentId, (long) amount, day,psd)
                        .subscribeOn(Schedulers.io())
                        .unsubscribeOn(Schedulers.io())
                        .observeOn(AndroidSchedulers.mainThread());
            case TYPE_POST:
                return mCircleClient.stickTopPost(parentId, (long) amount, day,psd)
                        .subscribeOn(Schedulers.io())
                        .unsubscribeOn(Schedulers.io())
                        .observeOn(AndroidSchedulers.mainThread());
            default:
    ...
    @Override
    public Observable<BaseJsonV2<Integer>> stickTop(String type, long parentId, long childId, double amount, int day,String psd) {
        switch (type) {
            case TYPE_DYNAMIC:
                return mDynamicClient.stickTopDynamicComment(parentId, childId, (long) amount, day,psd)
                        .subscribeOn(Schedulers.io())
                        .unsubscribeOn(Schedulers.io())
                        .observeOn(AndroidSchedulers.mainThread());
            case TYPE_INFO:
                return mInfoMainClient.stickTopInfoComment(parentId, childId, (long) amount, day,psd)
                        .subscribeOn(Schedulers.io())
                        .unsubscribeOn(Schedulers.io())
                        .observeOn(AndroidSchedulers.mainThread());
            case TYPE_POST:
                return mCircleClient.stickTopPostComment(parentId, childId, (long) amount, day,psd)
                        .subscribeOn(Schedulers.io())
                        .unsubscribeOn(Schedulers.io())
                        .observeOn(AndroidSchedulers.mainThread());
            default:
