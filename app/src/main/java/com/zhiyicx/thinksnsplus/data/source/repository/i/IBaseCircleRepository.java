...
public interface IBaseCircleRepository {
    ...
    Observable<List<CirclePostListBean>> getPostListFromCircle(long circleId, long maxId, String type,Integer excellent);
    Observable<List<CirclePostListBean>> getPrePostListFromCircle(Long circleId);
    ...
    void dealExcellent(long postId);

    Observable<BaseJsonV2<Object>> dealCircleJoinOrExit(CircleInfo circleInfo,String psd);
