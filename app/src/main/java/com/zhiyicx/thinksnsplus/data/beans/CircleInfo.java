...
public class CircleInfo extends BaseListBean implements Serializable {
    ...
    public void setCircleMembers(List<CircleMembers> circleMembers) {
    ...
    public int getExcellen_posts_count() {
        return excellen_posts_count;
    }

    public void setExcellen_posts_count(int excellen_posts_count) {
        this.excellen_posts_count = excellen_posts_count;
    }
    ...
    @Generated(hash = 766316378)
    public CircleInfo(Long id, String name, Avatar avatar, int user_id, int join_income_count, int pinned_income_count,
            int excellen_posts_count, int category_id, String location, String longitude, String latitude, String geo_hash, String permissions,
            int allow_feed, String mode, int money, String summary, String notice, int users_count, int posts_count, int blacklist_count,
            int audit, String created_at, String updated_at, String join_at, CircleJoinedBean joined, UserInfoBean user,
            CircleJoinedBean founder, List<UserTagBean> tags, CircleTypeBean category) {
        this.id = id;
        this.name = name;
        this.avatar = avatar;
        this.user_id = user_id;
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(this.excellen_posts_count);
        ...
        dest.writeTypedList(this.circleMembers);
    }
    ...
    protected CircleInfo(Parcel in) {
        ...
        this.excellen_posts_count = in.readInt();
        ...
        this.circleMembers = in.createTypedArrayList(CircleMembers.CREATOR);
    }
