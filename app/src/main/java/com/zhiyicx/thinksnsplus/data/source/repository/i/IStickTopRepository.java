...
public interface IStickTopRepository {
     ...
     * @return
     */
    Observable<BaseJsonV2<Integer>> stickTop(String type, long parent_id, double amount, int day,String psd);
     ...
     * @return
     */
    Observable<BaseJsonV2<Integer>> stickTop(String type,long parent_id,long child_id, double amount, int day,String psd);
