 ...
 */
public class TSEaseChatFragment<P extends IBasePresenter> extends TSEaseBaseFragment<P> implements EMMessageListener, com
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            currentLoginUserName = AppApplication.getmCurrentLoginAuth().getUser().getName();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    protected void setUpView() {
        ...
        if (chatType == EaseConstant.CHATTYPE_SINGLE) {
            ...
            if (EaseUserUtils.getUserInfo(toChatUsername) != null) {
                ...
                if (user != null) {
                    mToolbarCenter.setText(user.getNickname());
                }
            }
    ...
    protected void onMessageListInit(EaseChatRow.OnTipMsgClickListener onTipMsgClickListener) {
        messageList.init(toChatUsername, chatType, chatFragmentHelper != null ?
                chatFragmentHelper.onSetCustomChatRowProvider() : null, onTipMsgClickListener, null);
    ...
    @SuppressLint("ClickableViewAccessibility")
    protected void onMessageListInit(EaseChatRow.OnTipMsgClickListener onTipMsgClickListener,
                                     EaseChatRowPresenter.MessageErrorListener messageErrorListener) {
        messageList.init(toChatUsername, chatType, chatFragmentHelper != null ?
                chatFragmentHelper.onSetCustomChatRowProvider() : null, onTipMsgClickListener, messageErrorListener);
        setListItemClickListener();
        messageList.getListView().setOnTouchListener((v, event) -> {
            hideKeyboard();
            inputMenu.hideExtendMenuContainer();
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            if (requestCode == REQUEST_CODE_CAMERA) { // capture new image
                ...
                if (!data.hasExtra(TSEMConstants.BUNDLE_LOCATION_LATITUDE)) {
                    ToastUtils.showToast(R.string.unable_to_get_loaction);
                    return;
                }
                double latitude = data.getDoubleExtra(TSEMConstants.BUNDLE_LOCATION_LATITUDE, 0);
                double longitude = data.getDoubleExtra(TSEMConstants.BUNDLE_LOCATION_LONGITUDE, 0);
                String locationAddress = data.getStringExtra(TSEMConstants.BUNDLE_LOCATION_ADDRESS);
                String image = data.getStringExtra(TSEMConstants.BUNDLE_LOCATION_IMAGE);
                String title = data.getStringExtra(TSEMConstants.BUNDLE_LOCATION_TITLE);
                if (locationAddress != null && !locationAddress.equals("")) {
                    sendLocationMessage(latitude, longitude, title, locationAddress, image);
                } else {
                    ToastUtils.showToast(R.string.unable_to_get_loaction);
                }
    ...
    protected void sendTextMessage(String content) {
        if (EaseAtMessageHelper.get().containsAtUsername(content)) {
            ...
            try {
                extObject.put("em_push_name", getString(com.zhiyicx.thinksnsplus.R.string.app_name));
                extObject.put("em_push_content", currentLoginUserName + ":" + content);
    ...
    protected void sendVoiceMessage(String filePath, int length) {
        ...
        try {
            extObject.put("em_push_name", getString(com.zhiyicx.thinksnsplus.R.string.app_name));
            extObject.put("em_push_content", currentLoginUserName + ":" + com.zhiyicx.thinksnsplus.R.string.chat_type_voice);
        } catch (JSONException e) {
            e.printStackTrace();
        }
        // 将推送扩展设置到消息中
    ...
    protected void sendImageMessage(String imagePath) {
        ...
        try {
            extObject.put("em_push_name", getString(com.zhiyicx.thinksnsplus.R.string.app_name));
            extObject.put("em_push_content", currentLoginUserName + ":" + com.zhiyicx.thinksnsplus.R.string.chat_type_image);
        } catch (JSONException e) {
            e.printStackTrace();
        }
        // 将推送扩展设置到消息中
    ...
    protected void sendLocationMessage(double latitude, double longitude, String locationName, String locationAddress, String imagePath) {
        boolean isGif = DealPhotoUtils.checkPhotoIsGif(imagePath);
        boolean isNeedOrinImage = isGif || DealPhotoUtils.checkPhotoIsLongImage(imagePath);
        ...
        message.setAttribute(TSEMConstants.BUNDLE_LOCATION_ADDRESS, locationAddress);
        message.setAttribute(TSEMConstants.BUNDLE_LOCATION_TITLE, locationName);
        message.setAttribute(TSEMConstants.BUNDLE_LOCATION_IMAGE, true);
        // 设置自定义推送提示
        JSONObject extObject = new JSONObject();
        try {
            extObject.put("em_push_name", getString(com.zhiyicx.thinksnsplus.R.string.app_name));
            extObject.put("em_push_content", currentLoginUserName + ":"+ com.zhiyicx.thinksnsplus.R.string.chat_type_location);
        } catch (JSONException e) {
            e.printStackTrace();
        }
        // 将推送扩展设置到消息中
    ...
    protected void sendVideoMessage(String videoPath, String thumbPath, int videoLength) {
        ...
        try {
            extObject.put("em_push_name", getString(com.zhiyicx.thinksnsplus.R.string.app_name));
            extObject.put("em_push_content", currentLoginUserName + ":"+ com.zhiyicx.thinksnsplus.R.string.chat_type_video);
        } catch (JSONException e) {
            e.printStackTrace();
        }
        // 将推送扩展设置到消息中
    ...
    protected void sendFileMessage(String filePath) {
        ...
        try {
            extObject.put("em_push_name", getString(com.zhiyicx.thinksnsplus.R.string.app_name));
            extObject.put("em_push_content", currentLoginUserName + ":"+ com.zhiyicx.thinksnsplus.R.string.chat_type_file);
        } catch (JSONException e) {
            e.printStackTrace();
        }
        // 将推送扩展设置到消息中
