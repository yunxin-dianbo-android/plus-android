 ...
 * @Description
 */
public class CirclePostListItemForFiveImage extends CirclePostListBaseItem {

    private static final int IMAGE_COUNTS = 5;// 动态列表图片数量
    private static final int CURREN_CLOUMS = 3;// 当前列数
    
    public CirclePostListItemForFiveImage(Context context) {
        super(context);
    }

    @Override
    public int getItemViewLayoutId() {
        return R.layout.item_circle_post_list_five_image;
    }
