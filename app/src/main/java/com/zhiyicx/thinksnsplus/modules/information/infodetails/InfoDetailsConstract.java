...
public interface InfoDetailsConstract {
    ...
    interface View extends ITSListView<InfoCommentListBean, Presenter> {
        ...
        void upDateFollowFansState(boolean follower);
    }
    ...
    interface Presenter extends ITSListPresenter<InfoCommentListBean> {
        ...
        void shareInfo(Bitmap bitmap,List<UmengSharePolicyImpl.ShareBean> extraData);
        ...
        void handleFollowUser(UserInfoBean authorUserInfoBean);

        /**
         * 更新本地用户信息
         */
        void updatePublishUserFromLocal();
    }
