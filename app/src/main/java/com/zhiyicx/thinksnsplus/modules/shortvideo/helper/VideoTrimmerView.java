...
import com.zycx.shortvideo.view.Thumb;
...
public class VideoTrimmerView extends FrameLayout {
    ...
    private void init(Context context) {
        ...
        LayoutInflater.from(context).inflate(R.layout.video_trimmer_old_view, this, true);
    ...
    private void setVideoURI(final Uri videoURI) {
        mSrc = videoURI;
    ...
    public void setVideoURL(final String videoURL) {
        mSrcUrl = videoURL;
        mVideoView.setVideoPath(mSrcUrl);
        mVideoView.requestFocus();
    }
    ...
    public void onSaveClicked() {
        if (mEndPosition / 1000 - mStartPosition / 1000 < TrimVideoUtil.MIN_TIME_FRAME) {
            ...
            mVideoView.pause();
            TrimVideoUtil.trim(mContext, mSrcUrl, com.zycx.shortvideo.utils.FileUtils.getPath(ParamsManager.VideoPath,System.currentTimeMillis()+ ParamsManager.CompressVideo),
    ...
    class CoverAdapter extends RecyclerView.Adapter<Holder> {
        ...
        public void onBindViewHolder(Holder holder, int position) {
            ...
            String path = coverList.get(position).url;
    ...
    public static class Video {
        ...
        public Video(String url, long mecs) {
            this.url = url;
            this.mecs = mecs;
        }
    }
