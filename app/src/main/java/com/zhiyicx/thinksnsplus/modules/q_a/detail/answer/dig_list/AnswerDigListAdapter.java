...
public class AnswerDigListAdapter extends CommonAdapter<AnswerDigListBean> {
    ...
    protected void convert(ViewHolder holder, final AnswerDigListBean dynamicDigListBean, final int position) {
        ...
        if (dynamicDigListBean != null && dynamicDigListBean.getUser_id() == authBean.getUser_id()) {
            ...
            iv_follow.setPadding(mContext.getResources().getDimensionPixelOffset(R.dimen.spacing_normal),
                    mContext.getResources().getDimensionPixelOffset(R.dimen.spacing_small),
                    mContext.getResources().getDimensionPixelOffset(R.dimen.spacing_normal),
                    mContext.getResources().getDimensionPixelOffset(R.dimen.spacing_small));
            if (dynamicDigListBean.getDiggUserInfo().isFollowing()&&dynamicDigListBean.getDiggUserInfo().isFollower()) {
                ...
                iv_follow.setPadding(mContext.getResources().getDimensionPixelOffset(R.dimen.spacing_mid_small_6dp),
                        mContext.getResources().getDimensionPixelOffset(R.dimen.spacing_small),
                        mContext.getResources().getDimensionPixelOffset(R.dimen.spacing_mid_small_6dp),
                        mContext.getResources().getDimensionPixelOffset(R.dimen.spacing_small));
