 ...
 * @Description
 */
public class DynamicListItemForwardAnswer extends DynamicListBaseItem {

    public DynamicListItemForwardAnswer(Context context) {
        super(context);
    }
    ...
    public int getItemViewLayoutId() {
        return R.layout.item_dynamic_list_forward_answer;
    }
