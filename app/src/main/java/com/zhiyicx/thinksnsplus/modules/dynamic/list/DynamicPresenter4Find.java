 ...
 */
@FragmentScoped
public class DynamicPresenter4Find extends BaseDynamicPresenter<DynamicContract.View<DynamicContract.Presenter>, DynamicContract.Presenter> {

    @Inject
    public DynamicPresenter4Find(DynamicContract.View rootView,
