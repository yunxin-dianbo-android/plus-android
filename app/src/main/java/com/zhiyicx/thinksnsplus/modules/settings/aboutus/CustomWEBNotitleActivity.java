...
public class CustomWEBNotitleActivity extends TSActivity<RegisterPresenter, CustomWEBNotitleFragment> {
    ...
    public static void startToWEBActivity(Context context, HashMap<String, String> headers, String... args) {
        flag = "";
        Intent intent = new Intent(context, CustomWEBNotitleActivity.class);
    ...
    @Override
    protected CustomWEBNotitleFragment getFragment() {
        return CustomWEBNotitleFragment.newInstance(getIntent().getExtras());
    }
