...
public class ChatInfoPresenter extends AppBasePresenter<ChatInfoContract.View>
    ...
    public void destoryOrLeaveGroup(String chatId) {
        Subscription subscription = Observable.just(chatId)
                ...
                .subscribe(new BaseSubscribeForV2<String>() {
                    ...
                    protected void onSuccess(String data) {
                        EventBus.getDefault().post(new String[]{data, mContext.getString(isGroupOwner()?R.string.group_dissolution:R.string.group_exit,
                                mRootView.getGroupBean().getName())}, EVENT_IM_DELETE_QUIT);
