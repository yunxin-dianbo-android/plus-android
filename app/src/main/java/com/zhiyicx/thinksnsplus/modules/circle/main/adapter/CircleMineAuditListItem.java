...
public class CircleMineAuditListItem extends BaseCircleItem {
    ...
    public void convert(ViewHolder holder, CircleInfo circleInfo, CircleInfo lastT, int position, int itemCounts) {
        ...
        // 时间
        holder.setText(R.id.tv_circle_time, TimeUtils.getStandardTimeWithYeay(TimeUtils.
                utc2LocalLong(AppApplication.getMyUserIdWithdefault() == circleInfo.getUser_id() ?
                        circleInfo.getCreated_at() : circleInfo.getJoin_at())));
