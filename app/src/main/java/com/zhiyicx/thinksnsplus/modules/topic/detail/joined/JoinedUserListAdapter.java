...
public class JoinedUserListAdapter extends CommonAdapter<UserInfoBean> {
    private JoinedUserContract.Presenter mPresenter;

    public JoinedUserListAdapter(Context context, int layoutId, List<UserInfoBean> datas, JoinedUserContract.Presenter presenter) {
    ...
    private void setItemData(final ViewHolder holder, final UserInfoBean userInfoBean1, final int position) {
        ...
        CheckBox follow = holder.getView(R.id.iv_user_follow);
        follow.setPadding(mContext.getResources().getDimensionPixelOffset(R.dimen.button_follow_margin_10dp),
        ...
        RxView.clicks(holder.getView(R.id.iv_user_follow))
                ...
                .subscribe(aVoid -> {
                    ...
                    mPresenter.handleUserFollowState(position,userInfoBean1);
                });
    ...
    public void setPresenter(JoinedUserContract.Presenter presenter) {
