...
public class CustomWEBNotitleFragment extends TSWebFragment {
    ...
    public CustomWEBNotitleFragment() {
        // Required empty public constructor
    }

    public static CustomWEBNotitleFragment newInstance(Bundle bundle) {
        CustomWEBNotitleFragment fragment = new CustomWEBNotitleFragment();
        if (bundle != null) {
