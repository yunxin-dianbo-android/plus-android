...
public class ChatPresenter extends AppBasePresenter<ChatContract.View> implements ChatContract.Presenter {
    ...
    public void dealMessages(List<EMMessage> messages) {
        Subscription subscription = Observable.just(messages)
    ...
    @Override
    public void getCircleInfo(Long circleId,Long postId) {
        mBaseCircleRepository.getCircleInfo(circleId)
                ...
                .subscribe(new BaseSubscribeForV2<CircleInfo>() {
                    ...
                    protected void onSuccess(CircleInfo data) {
                        mRootView.gotoCircleDetail(data, postId);
                    }
    ...
    @Override
    public String getCurrenLoginUserName(long myUserIdWithdefault) {
        // 尝试从数据库获取当前用户的信息
