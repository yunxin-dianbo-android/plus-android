...
public class CirclePostListItemForShorVideo extends CirclePostListBaseItem {
    ...
    public CirclePostListItemForShorVideo(Context context, ZhiyiVideoView.ShareInterface shareInterface) {
        super(context);
...
//        return R.layout.item_dynamic_list_one_video;
        return R.layout.item_circle_post_list_one_video;
    }
    ...
    @Override
    public void convert(ViewHolder holder, final CirclePostListBean dynamicBean, CirclePostListBean lastT, int position, int itemCounts) {
...
//        LogUtils.d("------------video = " + (System.currentTimeMillis() - start));
    ...
    public boolean isForViewType(CirclePostListBean item, int position) {
        boolean isForView = item.getVideo() != null && item.getFeed_from() != DEFAULT_ADVERT_FROM_TAG;
        return isForView;
    }
