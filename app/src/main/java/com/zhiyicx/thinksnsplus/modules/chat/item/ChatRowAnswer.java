 ...
 * @Description 回答私信
 */
public class ChatRowAnswer extends ChatBaseRow {
    private TextView mTvChatContent;
    private TextView mTvQuestionTitle;

    public ChatRowAnswer(Context context, EMMessage message, int position, BaseAdapter adapter, ChatUserInfoBean userInfoBean) {
    ...
    protected void onInflateView() {
        inflater.inflate(message.direct() == EMMessage.Direct.SEND ?
                R.layout.item_chat_list_send_answer : R.layout.item_chat_list_receive_answer, this);
    }
