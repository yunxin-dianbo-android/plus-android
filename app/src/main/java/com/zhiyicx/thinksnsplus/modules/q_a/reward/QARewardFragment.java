...
public class QARewardFragment extends TSFragment<QARewardContract.Presenter> implements QARewardContract.View,
    ...
    protected void snackViewDismissWhenTimeOut(Prompt prompt) {
        ...
        if (prompt == Prompt.DONE) {
            // 发布成功后，要跳转问题详情
//            startCirclePostDetailActivity(new Intent(getActivity(), QA_Activity.class));
            goToQuestionDetail();
            getActivity().finish();
    ...
    public void onSureClick(View v, String text, InputPasswordView.PayNote payNote) {
        if (mQuestionId.equals(0L)) {
            mQAPublishBean.setPassword(payNote.psd);
            mPresenter.publishQuestion(mQAPublishBean);
        } else {
            mPresenter.resetReward(mQuestionId, mRewardMoney, payNote.psd);
        }
    }
    ...
    private void initAlertPopupWindow() {
        ...
        mRulePop = CenterInfoPopWindow.builder()
                ...
                .desStr(mPresenter.getSystemConfigBean().getQuestionConfig() != null ? mPresenter.getSystemConfigBean().getQuestionConfig()
                        .getReward_rule() : "")
...
//            configSureButton();
        ...
        RxView.clicks(mBtQaSelectExpert)
                ...
                .subscribe(aVoid -> {
                    ...
                    if (mQAPublishBean != null && mQAPublishBean.getTopics() != null) {
                ...
                .subscribe(aVoid -> {
                    ...
                    try {
                        if (mQuestionId.equals(0L)) {
                            ...
                            if (mPresenter.usePayPassword() && mRewardMoney > 0) {
                            ...
                            if (mPresenter.usePayPassword()) {
                                ...
                                mPresenter.resetReward(mQuestionId, mRewardMoney, null);
                            }
                        }
                    } catch (Exception e) {
                        mBtPublish.setEnabled(true);
    ...
    @Override
    public void publishQuestionFailed(String msg) {
