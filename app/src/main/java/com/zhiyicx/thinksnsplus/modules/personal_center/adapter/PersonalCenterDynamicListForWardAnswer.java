...
public class PersonalCenterDynamicListForWardAnswer extends PersonalCenterDynamicListBaseItem {
    public PersonalCenterDynamicListForWardAnswer(Context context) {
        super(context);
    }

    @Override
    public int getItemViewLayoutId() {
        return R.layout.item_personal_center_dynamic_list_forward_answer;
    }
    ...
    public boolean isForViewType(DynamicDetailBeanV2 item, int position) {
        ...
        return item.getFeed_mark() != null &&
                ...
                item.getVideo() == null &&
                letter != null &&
                TSEMConstants.BUNDLE_CHAT_MESSAGE_FORWARD_TYPE_ANSWERS.equals(letter.getType());
    }
...
//        links.add(link);
        ...
        RxView.clicks(holder.getView(R.id.tv_forward_container))
                ...
                .subscribe(aVoid -> AnswerDetailsActivity.startAnswerDetailsActivity(mContext,
