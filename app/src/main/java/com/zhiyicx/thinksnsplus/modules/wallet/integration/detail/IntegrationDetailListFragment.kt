...
//                    state 	订单状态 0 - 等待、1 - 完成、-1 - 失败
            ...
            RxView.clicks(mTvRule)
                    ...
                    .subscribe {
                        ...
                        if (mSystemConfigBean.currency.rule != null) {
                            val bundle = Bundle()
                            bundle.putString(WalletRuleFragment.BUNDLE_RULE, mSystemConfigBean.currency.rule)
    ...
    override fun setUseShadowView(): Boolean {
        return true
    }

    override fun onShadowViewClick() {}
