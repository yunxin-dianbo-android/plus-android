...
import com.zhiyicx.thinksnsplus.modules.draftbox.adapter.InfoDraftItem;
...
public class DraftBoxFragment extends TSListFragment<DraftBoxContract.Presenter, BaseDraftBean>
    ...
    public static final String MY_DRAFT_TYPE_INFO = "3";
    ...
    protected RecyclerView.Adapter getAdapter() {
        ...
        InfoDraftItem infoDraftItem = new InfoDraftItem(getActivity());
        ...
        adapter.addItemViewDelegate(infoDraftItem);
        ...
        infoDraftItem.setQuestionDraftItemEvent(this);
        return adapter;
    }
    ...
    public void toEditDraft(BaseDraftBean draftBean) {
        ...
        }else if (draftBean instanceof InfoDraftBean) {
            InfoDraftBean realData = (InfoDraftBean) draftBean;
            EditeInfoDetailActivity.startEditeInfoDetailActivity(mActivity,realData.getInfoPublishBean());
        }
    }
