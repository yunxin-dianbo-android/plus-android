...
//            }
    ...
    public void startWindowFullscreen() {
        ...
        try {
            ...
            Drawable bgDrawable = firstVideoView.getBackground();
            Bitmap src = null;
            if (bgDrawable instanceof BitmapDrawable) {
                src = ((BitmapDrawable) bgDrawable).getBitmap();
            } else if (bgDrawable instanceof RoundedBitmapDrawable) {
                src = ((RoundedBitmapDrawable) bgDrawable).getBitmap();
            } else {
                src = ConvertUtils.drawable2Bitmap(bgDrawable);
            }
