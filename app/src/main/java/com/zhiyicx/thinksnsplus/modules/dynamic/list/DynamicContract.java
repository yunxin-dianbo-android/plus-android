...
public interface DynamicContract {
    ...
    interface View<P extends Presenter> extends ITSListViewForDownload<DynamicDetailBeanV2, P> {
        /**
         * get dynamic type
         *
         * @return dynamic type
         ...
         */
        void showNewDynamic(int position,boolean isForward);

        String getKeyWord();

        void showBottomView(boolean isShow);
    ...
    interface Presenter extends ITSListPresenterForDownload<DynamicDetailBeanV2> {
        ...
        void payNote(int dynamicPosition,int imagePosition,int note,boolean isImage,String psd);
