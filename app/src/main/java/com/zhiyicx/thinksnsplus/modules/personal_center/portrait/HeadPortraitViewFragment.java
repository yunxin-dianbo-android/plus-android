...
public class HeadPortraitViewFragment extends TSFragment<HeadPortraitViewContract.Presenter>
    ...
    protected void initData() {
        ...
        if (mUserInfoBean != null && mUserInfoBean.getAvatar() != null) {
            String userIconUrl = mUserInfoBean.getAvatar().getUrl();
    ...
    private void initListener() {
        ...
        RxView.clicks(mIvPortraitPreview)
                ...
                .subscribe(aVoid -> {
                    ...
                    String userIconUrl = "none";
                    if (mUserInfoBean.getAvatar() != null) {
                        userIconUrl = mUserInfoBean.getAvatar().getUrl();
                    }
                    // 这个付费才能查看他人的头像吗？
                    ...
                    imageBean.setImgUrl(userIconUrl);
    ...
    public void saveImage() {
        ...
        int width = UIUtils.getWindowWidth(getContext());
        int height = UIUtils.getWindowHeight(getContext()) * 2 / 3;
        String rule = "?rule=w_" + width + ",h_" + height + ",b_60";
        String userIconUrl = rule;
        if (mUserInfoBean.getAvatar() != null) {
            userIconUrl = mUserInfoBean.getAvatar().getUrl() + rule;
        }

//        GlideUrl glideUrl = ImageUtils.imagePathConvertV2(userIconUrl, AppApplication.getTOKEN());
