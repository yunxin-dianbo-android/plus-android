...
//        return Arrays.asList(getString(R.string.draft_type_questions), getString(R.string.draft_type_answers),getString(R.string.post),getString(R.string.information));
    ...
    protected List<Fragment> initFragments() {
        if (mFragmentList == null) {
            ...
            Fragment infoDraft = DraftBoxFragment.getInstance(DraftBoxFragment.MY_DRAFT_TYPE_INFO);
