...
public class SearchExpertAdapter extends CommonAdapter<ExpertBean> {
    ...
    protected void convert(ViewHolder holder, ExpertBean expertBean, int position) {
        ...
        LinearLayout.LayoutParams params = (LinearLayout.LayoutParams) ftlTags.getLayoutParams();
        ...
        params.rightMargin = mContext.getResources().getDimensionPixelOffset(subscrib.getVisibility() == View.VISIBLE ? R.dimen.dp70 : R.dimen.dp20);
