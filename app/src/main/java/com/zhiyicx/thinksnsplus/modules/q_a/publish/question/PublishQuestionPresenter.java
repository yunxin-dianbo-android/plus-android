    ...
    public void checkQuestionConfig() {
        ...
        if (systemConfigBean==null || systemConfigBean.getQuestionConfig()==null) {
            mBaseQARepository.getQuestionConfig()
                    .subscribe(new BaseSubscribeForV2<SystemConfigBean.QuestionConfig>() {
                        @Override
                        protected void onSuccess(SystemConfigBean.QuestionConfig data) {
                            systemConfigBean.setQuestionConfig(data);
