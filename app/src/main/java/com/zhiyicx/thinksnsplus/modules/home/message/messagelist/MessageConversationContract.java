...
public interface MessageConversationContract {
     ...
     */
    interface View<P extends Presenter<T>,T extends MessageItemBeanV2> extends ITSListView<T, P> {
    ...
    interface Presenter<T extends MessageItemBeanV2> extends ITSListPresenter<T> {
