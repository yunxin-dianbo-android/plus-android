 ...
 * @Description
 */
public class DynamicListItemForwardQuestion extends DynamicListBaseItem {

    public DynamicListItemForwardQuestion(Context context) {
        super(context);
    }
    ...
    public int getItemViewLayoutId() {
        return R.layout.item_dynamic_list_forward_question;
    }
