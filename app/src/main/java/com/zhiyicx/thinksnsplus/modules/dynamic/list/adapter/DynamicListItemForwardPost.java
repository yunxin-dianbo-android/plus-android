 ...
 * @Description
 */
public class DynamicListItemForwardPost extends DynamicListBaseItem {

    public DynamicListItemForwardPost(Context context) {
        super(context);
    }
    ...
    public int getItemViewLayoutId() {
        return R.layout.item_dynamic_list_forward_post;
    }
