...
public class UploadCoverFragment extends TSFragment<PublishInfoContract.Presenter>
    ...
    protected void setRightClick() {
        ...
        int imageId = RegexUtils.getImageId(EditeInfoDetailFragmentV2.mInfoPublishBean.getContent());
        if (EditeInfoDetailFragmentV2.mInfoPublishBean.isRefuse()) {
            EditeInfoDetailFragmentV2.mInfoPublishBean.setImage((long) imageId < 0 ? null : (long) imageId);
        } else {
            EditeInfoDetailFragmentV2.mInfoPublishBean.setImage(EditeInfoDetailFragmentV2.mInfoPublishBean.getCover() < 0 ? null : (long)
                    EditeInfoDetailFragmentV2.mInfoPublishBean.getCover());
        }
    ...
    public void uploadPicSuccess(int id) {
        ...
        EditeInfoDetailFragmentV2.mInfoPublishBean.setImage((long) id);
    ...
    protected void initData() {
        ...
        if (EditeInfoDetailFragmentV2.mInfoPublishBean.getImage() != null) {
            ...
            Glide.with(getActivity())
                    .load(ImageUtils.imagePathConvertV2(EditeInfoDetailFragmentV2.mInfoPublishBean.getImage().intValue(), w, h, ImageZipConfig
                            .IMAGE_70_ZIP))
                    .centerCrop()
                    .into(mIvInfoCoverIamge);
        }
        mBtSure.setText(getString(mPresenter.getSystemConfigBean().getNewsContribute().getContribute().hasPay()
                && !EditeInfoDetailFragmentV2.mInfoPublishBean.isRefuse() ? R.string.publish_withpay_info : R.string.publish_info));
    ...
    private void initListener() {
        ...
        RxView.clicks(mBtSure)
                ...
                .subscribe(aVoid -> {
                    // 不要封面也可以发布了
//                    if (EditeInfoDetailFragmentV2.mInfoPublishBean.getImage() <= 0 && EditeInfoDetailFragmentV2.mInfoPublishBean.getCover() <= 0) {
//                        initWithdrawalsInstructionsPop();
//                        return;
//                    }
                    if (EditeInfoDetailFragmentV2.mInfoPublishBean.isRefuse()) {
                        mPresenter.publishInfo(EditeInfoDetailFragmentV2.mInfoPublishBean);
                        return;
                    }
    ...
    public void onSureClick(View v, String text, InputPasswordView.PayNote payNote) {
        EditeInfoDetailFragmentV2.mInfoPublishBean.setPassword(payNote.psd);
        mPresenter.publishInfo(EditeInfoDetailFragmentV2.mInfoPublishBean);
    }
    ...
    protected void snackViewDismissWhenTimeOut(Prompt prompt) {
        if (prompt == Prompt.DONE) {
            ...
            EditeInfoDetailFragmentV2.mInfoPublishBean = null;
    ...
    private void initPayInfoPopWindow() {
        if (!mPresenter.getSystemConfigBean().getNewsContribute().getContribute().hasPay()) {
            mPresenter.publishInfo(EditeInfoDetailFragmentV2.mInfoPublishBean);
            return;
        }
        ...
        mPayInfoPopWindow = PayPopWindow.builder()
                ...
                .buildDescrStr(String.format(getString(R.string.publish_pay_info) + getString(R
                        .string.buy_pay_member),mPresenter.getSystemConfigBean().getNewsContribute().getPay_contribute(), mPresenter.getGoldName()))
                ...
                .buildMoneyStr(String.format(getString(R.string.buy_pay_integration),""+ EditeInfoDetailFragmentV2.mInfoPublishBean.getAmout()))
                .buildCenterPopWindowItem1ClickListener(() -> {
///                    EditeInfoDetailFragmentV2.mInfoPublishBean.setContent(EditeInfoDetailFragmentV2.mInfoPublishBean.getSubject() +
/// EditeInfoDetailFragmentV2.mInfoPublishBean.getContent());
