...
public class AddTopicFragment extends TSListFragment<AddTopicContract.Presenter, QATopicBean>
    ...
    protected void setRightClick() {
        ...
        if (PublishQuestionFragment.gDraftQuestion.isHasAgainEdite() && (PublishQuestionFragment.gDraftQuestion.getAmount() > 0 ||
                PublishQuestionFragment.gDraftQuestion.isHasAdoption())) {
...
//        PublishQuestionFragment.gDraftQuestion.setSubject(mEtQustion.getText().toString());
    ...
    @Override
    protected Long getMaxId(@NotNull List<QATopicBean> data) {
        return super.getMaxId(data);
    }

    @Override
    protected void requestNetData(Long maxId, boolean isLoadMore) {
        requestNetData(mEtQustion.getText().toString(), maxId, null, isLoadMore);
    }
        ...
        RxTextView.textChanges(mEtQustion)
                .subscribe(charSequence -> {
                    if (TextUtils.isEmpty(charSequence)) {
                        ...
                        requestNetData(String.valueOf(charSequence), 0L, null, false);
                    }
                });
    }
    ...
    protected void initData() {
        ...
        if (PublishQuestionFragment.gDraftQuestion != null &&
                PublishQuestionFragment.gDraftQuestion.isHasAgainEdite() &&
                PublishQuestionFragment.gDraftQuestion.getAmount() > 0) {
