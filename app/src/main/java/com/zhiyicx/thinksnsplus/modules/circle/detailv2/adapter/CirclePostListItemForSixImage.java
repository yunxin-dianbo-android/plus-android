...
/**
 * @author Jliuer
 * @Date 2017/11/30/14:45
 * @Email Jliuer@aliyun.com
 * @Description
 */
public class CirclePostListItemForSixImage extends CirclePostListBaseItem {
    private static final int IMAGE_COUNTS = 6;// 动态列表图片数量
    private static final int CURREN_CLOUMS = 3;// 当前列数

    public CirclePostListItemForSixImage(Context context) {
        super(context);
    }

    @Override
    public int getItemViewLayoutId() {
        return R.layout.item_circle_post_list_six_image;
    }
