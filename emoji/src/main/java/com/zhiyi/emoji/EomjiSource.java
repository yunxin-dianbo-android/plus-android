...
//        for (int unicode = 0x24C2 ; unicode < 0x1F251 ; unicode++) {
    ...
    public static Map<String, String> emojiMap(String json) {
        Type type = new TypeToken<Map<String, String>>() {
        }.getType();
        return new Gson().fromJson(json, type);
    }

    public static List<Map<String, String>> emojiListMap(String fileName, Context context) {
        List<Map<String, String>> result = new ArrayList<>();
        result.add(emojiMap(getJson(fileName,context)));
        return result;
    }
}
