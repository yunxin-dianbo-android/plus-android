...
public class TSEMessageUtils {
    ...
    public static void sendImageLocationMessage(String image, String latitude, String longitude,
                                                String address, String name, boolean isNeedOrinImage, String toChatUsername) {
    ...
    public static void sendLetterMessage(String toChatUsername, String letterTitle, String letterContent,
                                         String letterMessage, String letterImage, String letterType,
                                         String letterFeedType,String letterId,EMMessage.ChatType chatType,String circleId) {

        if (TextUtils.isEmpty(letterContent)){
            letterContent = " ";
        }
        EMMessage message = EMMessage.createTxtSendMessage(letterContent, toChatUsername);

        message.setAttribute(TSEMConstants.BUNDLE_CHAT_MESSAGE_LETTER, letterType);
        message.setAttribute(TSEMConstants.BUNDLE_CHAT_MESSAGE_LETTER_TYPE_DYNAMIC_TYPE, letterFeedType);
        message.setAttribute(TSEMConstants.BUNDLE_CHAT_MESSAGE_LETTER_ID, letterId);
        message.setAttribute(TSEMConstants.BUNDLE_CHAT_MESSAGE_LETTER_TYPE_POST_CIRCLE_ID, circleId);
        message.setAttribute(TSEMConstants.BUNDLE_CHAT_MESSAGE_LETTER_IMAGE, letterImage);
        message.setAttribute(TSEMConstants.BUNDLE_CHAT_MESSAGE_LETTER_NAME, letterTitle);
        message.setAttribute(TSEMConstants.BUNDLE_CHAT_MESSAGE_LETTER_CONTENT, letterContent);
        message.setChatType(chatType);
        EMClient.getInstance().chatManager().sendMessage(message);

        if (!TextUtils.isEmpty(letterMessage)) {
            EMMessage extraMessage = EMMessage.createTxtSendMessage(letterMessage, toChatUsername);
            extraMessage.setChatType(chatType);
            EMClient.getInstance().chatManager().sendMessage(extraMessage);
        }
    }
