...
//    private SharedPreferences.Editor mEditor;
    ...
    public DragAdapter2(Context context, List<String> provinceList) {
...
//        if(convertView == null)
        ...
        final Object item = provinceList.get(position);
...
//        }
    ...
    public void exchange(int dragPosition, int dropPosition) {
        ...
        Object dragItem = (Object) getItem(dragPosition);
        if (dragPosition < dropPosition) {
            provinceList.add(dropPosition + 1, dragItem.toString());
            provinceList.remove(dragPosition);
        } else {
            provinceList.add(dropPosition, dragItem.toString());
